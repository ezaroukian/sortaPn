...
function genQuestion(list,vType,e,qType)
{
	...
	return [  [q, "Scale", {html: "Sentence: "+sent+"<br/><br/> Context: "+vHedge, "q":"How acceptable is the sentence as a description of the context?", scaleWidth: 500, scaleHeight: 10, buttonMessage: "Submit", startValue: 0, endValue:100}], [q, "Scale", {html: "Sentence: "+sent+"<br/><br/> Context: "+oHedge, "q":"How acceptable is the sentence as a description of the context?", scaleWidth: 500, scaleHeight: 10, buttonMessage: "Submit", startValue: 0, endValue:100}]  ];
}
