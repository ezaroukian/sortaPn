...
function genQuestion(list,vType,e,qType)
{
    ...
    return [  [q, "AcceptabilityJudgment", {"s": {html: "Sentence:"+sent+"<br/><br/> Context: "+vHedge}, "q":"How acceptable is the sentence as a description of the context?"}], [q, "AcceptabilityJudgment", {"s": {html: sent+"<br/><br/> Context: "+oHedge}, "q":"How acceptable is the sentence as a description of the context?"}]  ];
}
