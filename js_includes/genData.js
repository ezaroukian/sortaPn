...
["Irene", 
    ...
    "a storm", 
    ["hope for OBJECT", "fly through the very edge of OBJECT"], 
    "a bit of rain"
],
["Dennis", 
    ["was afraid of", "yelled at"],
	["be afraid of", "yell at"],	
    "a bee", 
    ["worry about his allergy to OBJECT", "squeal in alarm because of OBJECT"], 
    "a wasp"
],
["Katie", 
    ["EMPTY", "visited"], 
...
["Tony", 
    ...
    ["EMPTY", "hammer"], 
    "a nail", 
    ["EMPTY", "pound at OBJECT with his shoe"], 
    "a tack"
],
["Laura", 
    ["EMPTY", "wore"],
...
function buildList(list){
	for(i=0;i<list.length;i++){
		...
		var rep1 = list[i][4][0].replace("OBJECT", list[i][3]);//cre/ITV sent
		var rep2 = list[i][4][1].replace("OBJECT", list[i][3]);//other sent
		list[i][4] = [rep1,rep2];
